...
export function AudioPreview({ audioFile, onRemove }: AudioPreviewProps): JSX.Element {
  return (
    <Box bg="gray.1" p="md" style={{ borderRadius: '8px' }} mt="md">
      <Group justify="space-between" mb="xs">
        <Stack gap="xs">
          <Text size="sm" fw={500}>Audio Preview</Text>
          <Text size="xs" c="dimmed">{audioFile.name}</Text>
